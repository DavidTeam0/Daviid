...
os.execute('wget https://raw.githubusercontent.com/DavidTeam0/Daviid/master/David.lua')
os.execute('wget https://raw.githubusercontent.com/DavidTeam0/Daviid/master/start.lua')
dofile('David.lua')  
return false
end
if text == "راسلني" then
